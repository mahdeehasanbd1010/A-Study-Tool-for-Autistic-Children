...
import {AddStudentPage} from '../components/lesson_components/addStudentComponent';
...
import MCQ from '../components/MCQ/Paper';
...
import studentListComponent from '../components/lesson_components/allStudentList';
      ...
      <div className="app-container">
        ...
        <Router history={history}>
          <Switch>
            ...
            <Route path="/studentList" component={studentListComponent} />
            <Redirect from="*" to="/" />
          </Switch>
        </Router>
      </div>
