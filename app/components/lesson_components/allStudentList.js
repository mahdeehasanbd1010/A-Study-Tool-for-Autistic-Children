...
class studentListComponent extends Component {
  ...
  retrieveInfo(){
     ...
     new Promise((resolve, reject) => {
      ipc.send( 'FIND_ALL_STUDENT' );

      ipc.on('ALL_STUDENT_FETCHED', (event, result) => {
   ...
   console.log(this.state.retrieveLesson);
    return (
        ...
        >
            ...
            <NavTab className='navBarLink' to="/studentList"><button>Add New Lesson</button> </NavTab>
                  ...
                  to={{
                    ...
                    <div
                      style={{
                        ...
                        <img src={`assets/student/${lessonList.name}/${lessonList.name}_0.png`}
                          alt="Thumnail"
                          style={{
                            width: `${(size/5)*2}px`,
                            height: `${(size/5)*2}px`}}/>
...
studentListComponent.defaultProps = {
  size: 300
};
